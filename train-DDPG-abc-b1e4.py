...
if __name__ == "__main__":
    ...
    parser.add_argument("--policy", default="DDPG_abc_b1e4")  # Policy name (TD3, DDPG or OurDDPG)
    ...
    replay_buffer = utils.ReplayBuffer(state_dim, action_dim, max_size=int(5e5))
