...
if __name__ == "__main__":
    ...
    parser.add_argument("--policy", default="DDPG_abc_b1e4_CER")  # Policy name (TD3, DDPG or OurDDPG)
    ...
    replay_buffer = utils_CER.ReplayBuffer_CER(state_dim, action_dim, max_size=int(5e5))
    ...
    for t in range(int(args.max_timesteps)):
        ...
        # let's do this only when it's a done...
            if (episode_num + 1) % 10 == 0:
                ...
                resultsfile = f"./results/{file_name}"
