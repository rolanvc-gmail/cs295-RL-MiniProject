...
if __name__ == "__main__":
    ...
    parser.add_argument("--policy", default="DDPG_abc_b1e5_CER")  # Policy name (TD3, DDPG or OurDDPG)
    ...
    replay_buffer = utils_CER.ReplayBuffer_CER(state_dim, action_dim, max_size=int(1e5))
